...
namespace Client.MirScenes.Dialogs
{
    ...
    protected const long FadeDelay = 55;
        ...
        public string BuffString(ClientBuff buff)
        {
            ...
            switch (buff.Type)
            {
                ...
                case BuffType.ClearRing:
                    text += GameLanguage.Instance.BuffTypeHiding;
                    break;
                case BuffType.MoonLight:
                    text += GameLanguage.Instance.BuffTypeMoonLight;
                    break;
                case BuffType.EnergyShield:
                    overridestats = true;
                    text += string.Format(GameLanguage.Instance.BuffTypeEnergyShield, buff.Stats[Stat.EnergyShieldPercent], buff.Stats[Stat.EnergyShieldHPGain]);
                    break;
                case BuffType.DarkBody:
                    text += GameLanguage.Instance.BuffTypeDarkBody;
                    break;
                case BuffType.VampireShot:
                    text += GameLanguage.Instance.BuffTypeVampireShot;
                    break;
                case BuffType.PoisonShot:
                    text += GameLanguage.Instance.BuffTypePoisonShot;
                    break;
                case BuffType.Concentration:
                    text += GameLanguage.Instance.BuffTypeConcentration;
                    break;
                case BuffType.MagicBooster:
                    overridestats = true;
                    text += string.Format(GameLanguage.Instance.BuffTypeMagicBooster, buff.Stats[Stat.MinMC], buff.Stats[Stat.MaxMC], buff.Stats[Stat.ManaPenaltyPercent]);
                    break;
                case BuffType.Transform:
                    text += GameLanguage.Instance.BuffTypeTransform;
                    break;
                case BuffType.Mentee:
                    text += GameLanguage.Instance.BuffTypeMentee;
                    break;
                case BuffType.Guild:
                    text += GameScene.Scene.GuildDialog.ActiveStats;
                    break;
                case BuffType.Blindness:
                    text += GameLanguage.Instance.BuffTypeBlindness;
                    break;
                case BuffType.Newbie:
                    text += GameLanguage.Instance.BuffTypeNewbie;
                    break;
            }
            ...
            if (!string.IsNullOrEmpty(buff.Caster)) text += string.Format(GameLanguage.Instance.Caster, buff.Caster);
        ...
        {
            string text = GameLanguage.Instance.ActiveBuffs;
            var stats = new Stats();
    ...
    public sealed class PoisonBuffDialog : MirImageControl
    {
                ...
                case PoisonType.Green:
                    {
                        ...
                        var tickName = tick > 1 ? GameLanguage.Instance.Seconds : GameLanguage.Instance.Seconds;

                        text += string.Format(GameLanguage.Instance.PoisonTypeGreen, buff.Value, tick, tickName);
                    }
                    break;
                case PoisonType.Red:
                    {
                        ...
                        text += string.Format(GameLanguage.Instance.PoisonTypeRed, tick, tickName);
                    }
                    break;
                case PoisonType.Slow:
                    text += GameLanguage.Instance.PoisonTypeSlow;
                    break;
                case PoisonType.Frozen:
                    text += GameLanguage.Instance.PoisonTypeFrozen;
                    break;
                case PoisonType.Stun:
                    {
                        ...
                        text += string.Format(GameLanguage.Instance.PoisonTypeStun, tick, tickName);
                    }
                    break;
                case PoisonType.Paralysis:
                    text += GameLanguage.Instance.PoisonTypeParalysis;
                    break;
                case PoisonType.DelayedExplosion:
                    text += GameLanguage.Instance.PoisonTypeDelayedExplosion;
                    break;
                case PoisonType.Bleeding:
                    {
                        ...
                        text += string.Format(GameLanguage.Instance.PoisonTypeBleeding, buff.Value, tick, tickName);
                    }
                    break;
                case PoisonType.LRParalysis:
                    text += GameLanguage.Instance.PoisonTypeLRParalysis;
                    break;
                case PoisonType.Blindness:
                    text += GameLanguage.Instance.PoisonTypeBlindness;
                    break;
                case PoisonType.Dazed:
                    text += GameLanguage.Instance.PoisonTypeDazed;
                    break;
            }
        ...
        private string CombinedBuffText()
        {
            string text = GameLanguage.Instance.ActivePoisons;
