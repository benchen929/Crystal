    ...
    public sealed class FriendDialog : MirImageControl
    {
        ...
        public FriendDialog()
        {
            ...
            RemoveButton.Click += (o, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(string.Format(GameLanguage.Instance.RemoveFriendConfirm, SelectedFriend.Name), MirMessageBoxButtons.YesNo);
            ...
            WhisperButton.Click += (o, e) =>
            {
                ...
                {
                    GameScene.Scene.ChatDialog.ReceiveChat(GameLanguage.Instance.NotOnline, ChatType.System);
                    return;
                }
