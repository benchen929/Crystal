    ...
    public sealed class InventoryDialog : MirImageControl
    {
        ...
        public InventoryDialog()
        {
            ...
            AddButton.Click += (o1, e) =>
            {
                ...
                MirMessageBox messageBox = new MirMessageBox(string.Format(GameLanguage.Instance.ExtraSlots4, openGold), MirMessageBoxButtons.OKCancel);
        ...
        void Button_Click(object sender, EventArgs e)
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.Instance.ExtraSlots8, MirMessageBoxButtons.OKCancel);
