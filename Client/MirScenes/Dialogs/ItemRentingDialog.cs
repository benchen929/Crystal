...
namespace Client.MirScenes.Dialogs
{
    public sealed class ItemRentingDialog : MirImageControl
    {
        ...
        {
            var inputBox = new MirInputBox(string.Format(GameLanguage.Instance.RentDuration, RentalItem.FriendlyName, GameScene.Scene.GuestItemRentDialog.GuestName));
        ...
        public void RefreshInterface()
        {
            ...
            _rentalPeriodLabel.Text = string.Format(GameLanguage.Instance.RentalPeriod, RentalPeriod);
    ...
    public sealed class GuestItemRentingDialog : MirImageControl
    {
        ...
        public GuestItemRentingDialog()
        {
            ...
            _rentalPeriodLabel = new MirLabel
            {
                ...
                DrawFormat = TextFormatFlags.Left | TextFormatFlags.VerticalCenter,
                NotControl = true,
                Text = string.Format(GameLanguage.Instance.RentalPeriod, 0)
            };
        ...
        public void RefreshInterface()
        {
            ...
            _rentalPeriodLabel.Text = string.Format(GameLanguage.Instance.RentalPeriod, GuestRentalPeriod);
