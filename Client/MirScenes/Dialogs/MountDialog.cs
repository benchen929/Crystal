...
namespace Client.MirScenes.Dialogs
{
    public sealed class MountDialog : MirImageControl
    {
        ...
        private void DrawMountAnimation()
        {
            ...
            else
            {
                ...
                if (item != null)
                {
                    ...
                    MountLoyalty.Text = string.Format(GameLanguage.Instance.NameInfoLabel4, item.CurrentDura, item.MaxDura);
                }
            }
        ...
        public override void Show()
        {
            ...
            if (GameScene.User.MountType < 0)
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.Instance.NoMount, MirMessageBoxButtons.OK);
                messageBox.Show();
                return;
            }
