...
namespace Client.MirScenes.Dialogs
{
    public sealed class QuestListDialog : MirImageControl
    {
        ...
        public QuestListDialog()
        {
            ...
            _finishButton.Click += (o, e) =>
            {
                ...
                {
                    MirMessageBox messageBox = new MirMessageBox(GameLanguage.Instance.SelectReward);
                    messageBox.Show();
                    return;
                }
        ...
        {
            _availableQuestLabel.Text = string.Format(GameLanguage.Instance.ListLabel, Quests.Count);
    ...
    public sealed class QuestDetailDialog : MirImageControl
    {
        ...
        public QuestDetailDialog()
        {
            ...
            {
                MirMessageBox messageBox = new MirMessageBox(GameLanguage.Instance.CancelQuest, MirMessageBoxButtons.YesNo);
    ...
    public sealed class QuestDiaryDialog : MirImageControl
    {
        ...
        public void DisplayQuests()
        {
            ...
            _takenQuestsLabel.Text = string.Format(GameLanguage.Instance.ListLabel1, Quests.Count, Globals.MaxConcurrentQuests);
    ...
    public sealed class QuestMessage : MirControl
    {
        ...
        private string TaskTitle = GameLanguage.Instance.TaskTitle, ProgressTitle = GameLanguage.Instance.ProgressTitle, ReturnTitle = GameLanguage.Instance.ReturnTitle, TimeLimitTitle = GameLanguage.Instance.TimeLimitTitle;
    ...
    public sealed class QuestSingleQuestItem : MirControl
    {
        ...
        public QuestSingleQuestItem(ClientQuestProgress quest)
        {
            ...
            string state = quest.Completed ? GameLanguage.Instance.QuestComplete : GameLanguage.Instance.QuestInProgress;
